		...
		<React.Fragment>
			<div>
				...
				<div style={{ backgroundColor: "#43AECC", cursor: "pointer", width: 40 + "px", height: 40, margin: "auto", marginLeft: 0, marginTop: 5, padding: 5, borderRadius: 50 + "%", position: "absolute", top: 110, left: 100 }}>
					<label htmlFor="img_avatar" style={{ color: "white", textAlign: "center", fontWeight: "bold", }}> <img alt="1" src="../../assets/iconos/photo_white.png" style={{ width: 20, marginLeft: 5, marginTop: 5 }} /></label>
				</div>
			</div>
		</React.Fragment>
	)
